...
<p align="center">Gerador de QrCode que possibilita baixar o arquivo .png</p>

| :placard: Vitrine.Dev |                                                 |
| --------------------- | ----------------------------------------------- |
| :sparkles: Nome       | **QrCode**                                      |
| :label: Tecnologias   | React                                           |
| :rocket: URL          | https://diovanealves.github.io/QrCodeGenerator/ |
| :fire: Repositorio    | https://github.com/diovanealves/QrCodeGenerator |

![](public/preview.jpg#vitrinedev)

<p align="center">
Programa exclusivo e gratuito, promovido pelo Sujeiro Programador para ensino de tecnologias React. <br/>
</p>
